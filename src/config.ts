...
export const themeConfig: ThemeConfig = {
  ...
  global: {
    ...
    moreLocales: ['ja'], // ['de', 'en', 'es', 'fr', 'ja', 'ko', 'pl', 'pt', 'ru', 'zh', 'zh-tw']
    // post font style
  ...
  comment: {
    ...
    waline: {
      // server url
      serverURL: 'https://waline.nekotc.cn/',
      // emoji url
      emoji: [
